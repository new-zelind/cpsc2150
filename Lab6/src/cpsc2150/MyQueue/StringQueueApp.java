...
/**
 * Created by Zach Lindler and Paul Marcella on 2/20/20.
 */
        ...
        while(menuOption != 8){
            ...
            switch(menuOption){
                ...
                case 1:
                    ...
                    String tempString1 = scanner.nextLine();
                ...
                case 5:
                    ...
                    int newPosition = -1;
                    System.out.println("What do you want to add to the queue?");
                    String tempString2 = scanner.nextLine();
                    ...
                    q.insert(strToInsert, newPosition);
                    System.out.println(q.toString());
                    break;
